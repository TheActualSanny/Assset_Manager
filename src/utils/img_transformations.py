...
class ImageManager:
    ...
    @staticmethod
    def to_vertical(img_data: str, asset_ext: str) -> Tuple[str, str]:
        '''
        ...
        with Image.open(img_data) as img:
            ...
            new_img.save(new_stream, format = asset_ext)
            new_stream.seek(0)
        return base64.b64encode(new_stream.getvalue()).decode('utf-8')

    @staticmethod
    def to_landscape(img_data: str, asset_ext: str) -> str:
        '''
    ...
    @staticmethod
    def to_square(img_data: str, asset_ext: str) -> str:
        '''
    ...
    @staticmethod
    def to_portrait(img_data: str, asset_ext: str) -> str:
        '''
